...
public class ElectricWallTorchBlock extends WallTorchBlock implements BlockEntityProvider {

    public static final MapCodec<ElectricWallTorchBlock> CODEC = createCodec(
            settings -> new ElectricWallTorchBlock(ParticleTypes.ELECTRIC_SPARK, settings)
    );

    public ElectricWallTorchBlock(SimpleParticleType particle, Settings settings) {
